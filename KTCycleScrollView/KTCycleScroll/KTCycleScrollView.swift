...
@objc protocol KTCycleScrollViewDelegate
{
    /// 点击图片回调
    @objc optional func cycleScrollViewDidSelect(at index:Int, cycleScrollView:KTCycleScrollView)
    /// 图片滚动回调
    @objc optional func cycleScrollViewDidScroll(to index:Int, cycleScrollView:KTCycleScrollView)
}

class KTCycleScrollView: UIView, PageControlAlimentProtocol, EndlessScrollProtocol
{
//=======================================================
// MARK: 对外提供的属性
//=======================================================
    weak var delegate:KTCycleScrollViewDelegate?
...
//=======================================================
    ...
    fileprivate let CellID = "KTCycleCell"
...
//=======================================================
    ...
    deinit {
        ...
        print("KTCycleScrollView  deinit")
    }
...
// MARK: - KTCycleCell 相关
//=======================================================
extension KTCycleScrollView: UICollectionViewDelegate,UICollectionViewDataSource
{
    fileprivate func setupCollectionView()
    {
        ...
        collectionView?.register(KTCycleCell.self, forCellWithReuseIdentifier: CellID)
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell
    {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: CellID, for: indexPath) as! KTCycleCell
